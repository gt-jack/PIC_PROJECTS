...
void RTC_Read(unsigned char *h, unsigned char *m, unsigned char *s,
    ...
    *h = BCD_to_DEC(I2C_Read(1));
    I2C_Read(1);
    *d = BCD_to_DEC(I2C_Read(1));
    *mo = BCD_to_DEC(I2C_Read(1));
    *y = BCD_to_DEC(I2C_Read(0));
...
void main(void) {
    ...
    while(1) {
        ...
        LCD_Char('/');
        LCD_Char((mo/10)+'0'); LCD_Char((mo%10)+'0');
        LCD_Char('/');
        LCD_Char((y/10)+'0'); LCD_Char((y%10)+'0');
